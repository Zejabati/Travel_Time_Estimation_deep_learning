...
def collate_fn(data):
    ...
    traj_attrs = ['lngs', 'lats', 'states',  'dist_gap']
...
class BatchSampler:
    ...
    def __iter__(self):
        ...
        '''
        np.random.shuffle(list(self.indices))
...
def get_loader(batch_size, dict1):
    dataset = MySet(dict1=dict1)
